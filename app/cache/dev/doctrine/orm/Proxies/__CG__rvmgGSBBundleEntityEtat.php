...
namespace Proxies\__CG__\rvmg\GSBBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Etat extends \rvmg\GSBBundle\Entity\Etat implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'rvmg\\GSBBundle\\Entity\\Etat' . "\0" . 'idetat', '' . "\0" . 'rvmg\\GSBBundle\\Entity\\Etat' . "\0" . 'libelle');
        }
